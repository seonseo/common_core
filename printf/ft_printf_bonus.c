...
/*   Updated: 2024/01/11 21:37:31 by seonseo          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_print_read_flags(const char *format, size_t *i)
{

}

int	ft_print_read_width(const char *format, size_t *i)
{

}

int	ft_print_read_precision(const char *format, size_t *i)
{

}

int	ft_print_read_type(const char *format, size_t *i)
{
	
}

int	ft_print_input_check()
{
